...
import { GetProfileFeed } from '@app/data/channel'
...
function UserVideos({video, currentVideoId}) {
    ...
    const { isSuccess, isLoading, isError, error, hasNextPage, isFetchingNextPage, fetchNextPage, data: videos } = useInfiniteQuery(['single-profile-feed', profileID], ({ pageParam = ''}) => GetProfileFeed(profileID, -1, reader, pageParam, 15),
        {
            enabled: !!id,
